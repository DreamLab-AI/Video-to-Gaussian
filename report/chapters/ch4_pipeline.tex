...
\begin{figure}[htbp]
  \centering
  % Placeholder for viewer screenshot
  \fbox{\parbox{0.8\textwidth}{\centering\vspace{3cm}\textcolor{MidGrey}{\sffamily\small [Screenshot: gaussian-toolkit web viewer showing gallery reconstruction]}\vspace{3cm}}}
